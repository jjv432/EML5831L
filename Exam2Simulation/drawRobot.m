...
% Left wheel
x_left_wheel = [(-width/2), (-width/2), (-width/2 + 2*radius), (-width/2 + 2*radius), (-width/2)];
...
x_right_wheel = [(-width/2), (-width/2), (-width/2 + 2*radius), (-width/2 + 2*radius), (-width/2)];
...
%Plotting
h1 = fill(right_wheel_rotated_translated(1,:), right_wheel_rotated_translated(2,:), 'k');
h2 = fill(left_wheel_rotated_translated(1,:), left_wheel_rotated_translated(2,:), 'k');
